...
const index = () => {
  ...
  const handlePrint = async (data) => {
    try {
      const response = await axios.post(`/api/anteshtee_report`, data, {
        headers: {
      ...
      link.href = url;
      link.download = `AnteshteeReport_${formattedDate}.pdf`; // Use current timestamp for unique file name
      ...
      <div className="p-5">
        ...
        <div className="px-5 pb-7 dark:bg-background pt-1 w-full bg-white shadow-lg border  rounded-md">
          <div className="w-full py-3 flex justify-start items-center">
            <h2 className="text-lg  font-normal">Anteshtee Report</h2>
          </div>
          {/* row starts */}
